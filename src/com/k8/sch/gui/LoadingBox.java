...
public class LoadingBox extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoadingBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoadingBox().setVisible(true);
            }
        });
    }
...
class Progress extends Thread{
    ...
    public Progress(JProgressBar jp) {
        this.jp = jp;
    }
